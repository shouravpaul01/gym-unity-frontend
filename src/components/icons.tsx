...
export const GroupPeoleIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const PersonEditIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const CalenderClockIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const BarIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
